"""
Django settings for BackEndFayTour project.
...
SECRET_KEY = 'django-insecure--)621gc@o4b+p(=ni0n)q=j_18)b+he71tdree-@x+_o(8jbc1'
...
ROOT_URLCONF = 'BackEndFayTour.urls'
...
WSGI_APPLICATION = 'BackEndFayTour.wsgi.application'
